...
void conversaComAmigos(cliente_args_t* cliente) {
...
void fazPedido(cliente_args_t* cliente) {
    printf("Cliente %d fez pedido", cliente->id);
    sem_wait(&cliente->sem);
}

void esperaPedido(cliente_args_t* cliente) {
    printf("Cliente %d espera o pedido", cliente->id);
}

void recebePedido(cliente_args_t* cliente) {
    printf("Cliente %d recebe o pedido", cliente->id);
}

void consomePedido(cliente_args_t* cliente) {
    srand(time(NULL));
